...
function convertDayTime(date) {
	...
	let currentDayTime = `${day[date.getDay()]} ${hours}:${minutes}`;
...
currentDay.innerHTML = convertDate(date);

//refresh Day & Time
let curentDayTime = document.querySelector("#day-time");
curentDayTime.innerHTML = convertDayTime(date);
